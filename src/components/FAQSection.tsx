...
const faqs = [
  {
    ...
    a: "Pylon Energy is a certified NETCC Approved Seller and Clean Energy Council Retailer, delivering premium Tier-1 solar packages with local service and 25-year warranties. We prioritize transparent pricing, custom system engineering, and lifetime monitoring support.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes, Pylon Energy is a fully certified NETCC Approved Seller (New Energy Tech Consumer Code) and Clean Energy Council (CEC) Approved Retailer. This guarantees that we adhere to the highest standards of safety, quality, and consumer protection in Australia.",
  },
  {
