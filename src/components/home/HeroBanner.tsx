...
const slides = [
  ...
  {
    badge: "ENERGY STORAGE SOLUTIONS",
    title: "Power Your Home Day\nAnd Night With Batteries",
    ...
    secondaryCtaText: "Battery Storage",
    secondaryCtaLink: "/services/solar-batteries",
    gradient: "from-[#29ABE2] to-[#002B5C]",
  },
  {
  ...
  },
  {
    ...
    secondaryCtaText: "EV Charging",
    secondaryCtaLink: "/services/ev-charger",
    gradient: "from-[#FF7029] to-[#0D5DB5]",
  },
];
