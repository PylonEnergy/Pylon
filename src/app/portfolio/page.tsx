        ...
        <div className="container">
          <div className="section-header" style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <p className="section-subtitle">
              Every installation is backed by our 10-year workmanship warranty and performed by CEC-accredited electricians.
            </p>
          </div>
          ...
          <div className="portfolio-cta-section">
            <div className="portfolio-cta-card">
              ...
              <p>Get a free, no-obligation quote tailored to your home or business. Our CEC-accredited team will design the perfect system for your needs.</p>
