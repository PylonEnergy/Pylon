      ...
      <section className="section-padding bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-slate">
          ...
          <p className="text-pe-gray-600 text-sm leading-relaxed mb-6">
            Pylon Energy agrees to design, supply, and install solar panel configurations, battery storages, and EV chargers in accordance with Clean Energy Council guidelines.
          </p>
          ...
          <p className="text-pe-gray-600 text-sm leading-relaxed mb-6">
            Installations are completed by CEC-accredited electricians. The customer is responsible for obtaining any necessary landlord approvals, though we manage all connection approval paperwork with your Distributed Network Service Provider (DNSP).
          </p>
        </div>
      </section>
    </>
