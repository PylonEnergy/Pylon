...
const deals = [
  ...
  },
  {
    ...
    description:
      "The Small-scale Technology Certificate (STC) rebate is active now. Get up to $3,500 off a new residential solar system when installed by a CEC Approved Retailer like Pylon Energy.",
    highlights: [
      "Available on 6.6kW to 13.2kW systems",
      "Applied directly as discount at point of sale",
      "Must be CEC Approved installer (we are ✓)",
